    ...
    async def admin_notify(self,reminder_date,summary):
        ...
        if exists:
            ...
            for line in file_data:
                ...
                print(phone_nos)
                await self.send_whatapp_to_Prayas_admin(phone_nos,reminder_date,summary)  

    async def send_whatapp_to_Prayas_admin(self,phone_nos,reminder_date,summary):
