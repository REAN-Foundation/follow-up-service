...
import requests
import urllib.parse
from app.common.appointment.appointment_utils import has_patient_replied, isPatientAlreadyReplied, time_of_first_reminder, valid_appointment_status, validate_mobile
